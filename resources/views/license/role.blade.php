...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
                            ...
                            <div class="row g-4 align-items-center">
                                <div class="col-sm-auto ms-auto">
                                    <div class="hstack gap-2">
                                        ...
                                        <a class="btn btn-primary" href="{{ route('users.permission') }}"
                                            target="_blank">Permission List</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- Add New Role Modal -->
            <div class="modal fade" id="AddNewRoleModal" tabindex="-1" aria-modal="true" role="dialog"
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="heading-{{ $module }}">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapse-{{ $module }}" aria-expanded="true"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="d-flex align-items-center">
                                                                <input type="checkbox"
                                                                    ...
                                                                    onclick="checkAllPermissions('{{ Str::slug($group) }}');" />
...
@section('script_section')
    <script>
        ...
        $('#addRoleForm').on('submit', function(e) {
            const permissions = $('input[name="permission[]"]:checked').length;
            if (permissions === 0) {
                e.preventDefault();
